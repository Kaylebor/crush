...
2. Security Check: AST-based analysis blocks dangerous patterns (network-to-shell pipes, command substitution, system modification). Safe read-only commands execute without prompts
